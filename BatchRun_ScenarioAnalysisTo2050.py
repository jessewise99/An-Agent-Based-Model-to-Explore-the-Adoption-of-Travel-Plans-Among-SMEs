    ...
    for efficacy in efficacies:
      for run in range(N_RUNS):
        ...
        model = AdoptionModel(
          ...
          active_shocks= set(), # These are the policies in effect. Needs to be a set.
          shock_parameters= {}# These are the strengths of the policies, it needs to be a dictionary. 
          ) 
        
        policy_start_year = 2030

        for _ in range(T):
          if model.current_year == policy_start_year:
