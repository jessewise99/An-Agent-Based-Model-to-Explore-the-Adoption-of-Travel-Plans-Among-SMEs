...
class FirmAgent(Agent):
    ...
    def __init__(self, unique_id, model, sector, postcode, network_membership, size):
        super().__init__(self)  # Pass parameters to the parent class.
        ...
        print(f"Agent {self.unique_id} placed at: {self.pos}") # Debugging output to confirm agent placement
    ...
    def observe_peers(self):
        ...
        print("self.pos =", self.pos, "type:", type(self.pos))
        print("neighbors =", list(self.model.grid.get_neighbors(self.pos, include_center=False)))
