...
results = mesa.batch_run(
     AdoptionModel,
     parameters=params,
     iterations=1, # # This is now 1, 1 run for each of the 100 seeds.
...
pyreadr.write_rds("batch_results_2050_500Agents_100Iterations.rds", results_df) # Write it to an .rds file so I can analyse it in R.
