...
# Just checking the model is running before I add the data collector
print(f"Model has run for {T} time steps with {N} agents.")
print(len(model.agents))  # Should equal num_agents
